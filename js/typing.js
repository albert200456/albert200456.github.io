...
var typeWriter = function(index) {
  ...
  if (loc.id === 'line3') {
    var time = fullText.length * timeChar + 8 * timeChar;
    showOutput = setTimeout(function() {
      document.getElementById('line4').className = 'visible';
    }, time)
    var totalTime = fullText.length * timeChar + 20 * timeChar;
